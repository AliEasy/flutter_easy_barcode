...
extension AppTheme on ThemeData {
    ...
    return brightness == Brightness.light
        ? copyWith(
            ...
            appBarTheme: AppBarTheme(
              ...
              titleTextStyle: textTheme.bodyMedium?.apply(color: neutral.shade900),
              titleSpacing: 0,
              elevation: 0,
        ...
        : copyWith(
            ...
            appBarTheme: AppBarTheme(
              ...
              backgroundColor: Colors.white,
              titleTextStyle: textTheme.bodyMedium?.apply(color: neutral.shade900),
              // // iconTheme: iconTheme.copyWith(color: neutral.shade900),
              // // actionsIconTheme: iconTheme.copyWith(color: neutral.shade900),
              // centerTitle: false,
              titleSpacing: 0,
              elevation: 0,
              systemOverlayStyle: SystemUiOverlayStyle.dark,
  ...
  TextTheme _getDefaultTextTheme(Color color, String fontFamily) {
    return textTheme.copyWith(
      ...
      headlineMedium:
          textTheme.headlineMedium?.copyWith(height: 1.2, fontSize: 26, fontWeight: FontWeight.w400, fontFamily: fontFamily, color: color),
  ...
  TextTheme _getDefaultPersianTextTheme(Color color, String fontFamily) {
    return textTheme.copyWith(
      ...
      headlineMedium:
          textTheme.headlineMedium?.copyWith(height: 1.4, fontSize: 18, fontWeight: FontWeight.w400, fontFamily: fontFamily, color: color),
